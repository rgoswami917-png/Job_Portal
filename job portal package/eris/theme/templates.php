    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Raiya Chowkdi,Near Nagrik bank,Rk Prime,Rajkot</address>
          <p>
            <i class="icon-phone"></i> 78638 72065 <br>
            <i class="icon-envelope-alt"></i> jobportal@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Job Portal 2025 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
