...
// SITE_ROOT = the Job_Portal folder
defined('SITE_ROOT') ? null : define('SITE_ROOT', __DIR__ . DS);

// LIB_PATH = Job_Portal/include/
defined('LIB_PATH') ? null : define('LIB_PATH', SITE_ROOT . 'include' . DS);

// Load all the files
require_once(LIB_PATH . "config.php");
require_once(LIB_PATH . "function.php");
require_once(LIB_PATH . "session.php");
require_once(LIB_PATH . "accounts.php");
require_once(LIB_PATH . "autonumbers.php");
require_once(LIB_PATH . "companies.php");
require_once(LIB_PATH . "job.php");
require_once(LIB_PATH . "employees.php");
require_once(LIB_PATH . "categories.php");
require_once(LIB_PATH . "applicant.php");
require_once(LIB_PATH . "jobregistration.php");
